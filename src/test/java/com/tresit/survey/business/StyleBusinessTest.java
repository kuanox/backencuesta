...
public class StyleBusinessTest {
    ...
    public void testGetAllStyles() {
        Mockito.when(iStyleService.getAllStyles()).thenReturn(this.styleEntities);
        assertNotNull(iStyleService.getAllStyles());
    }

    @Test
    public void testGetStyleService() {
        List<StyleEntity> styleEntities = new ArrayList<>();
        styleEntities = iStyleService.getAllStyles();
        assertNotNull(styleEntities);
    }
